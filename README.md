...
Finally, configure your desired URL in `siteConfig.ts`, so links (e. g. canonical links) are generated correctly. You can also update other default values, such as `postsPerPage` in this file.
